...
public class CryptoObjectCreator {
    private final String TAG = "CryptoObjectCreator";
    ...
    private KeyStore providesKeystore() {
        try {
            ...
            Log.d(TAG, "Failed to get an instance of KeyStore");
            return null;
        }
    }
    ...
    private KeyGenerator providesKeyGenerator() {
        try {
            ...
            Log.d(TAG, "Failed to get an instance of KeyGenerator");
            return null;
        }
    }
    ...
    private Cipher providesCipher(KeyStore keyStore) {
        try {
            ...
            Log.d(TAG, "Failed to get an instance of Cipher");
            return null;
        }
    }
